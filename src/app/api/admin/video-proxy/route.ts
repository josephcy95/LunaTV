...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Keep the TVBox source API proxy in sync with the same Worker setting.
    // The admin panel historically saved only VideoProxyConfig, so /api/tvbox
    // continued to emit direct upstream APIs even when this switch was on.
