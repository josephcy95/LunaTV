...
// DB query counting is process-global and cannot be attributed safely to one request.
// Keep legacy functions for non-request diagnostics, but request metrics must omit dbQueries.
let dbQueryCount = 0;
